...
import cuban.social.testnetwork.SearchActivity;
import cuban.social.testnetwork.adapter.PeopleListAdapter;
import cuban.social.testnetwork.app.App;
import cuban.social.testnetwork.common.ActivityBase;
import cuban.social.testnetwork.groupchat.adapters.InviteListAdapter;
...
public class NewMemberSearchActivity extends ActivityBase implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new InviteListAdapter(NewMemberSearchActivity.this, searchList, groupID);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent intent = new Intent(NewMemberSearchActivity.this, ProfileActivity.class);
...
//        super.onCreateOptionsMenu(menu);
        ...
        SearchManager searchManager = (SearchManager) NewMemberSearchActivity.this.getSystemService(Context.SEARCH_SERVICE);
        ...
        if (searchView != null) {
            ...
            searchView.setSearchableInfo(searchManager.getSearchableInfo(NewMemberSearchActivity.this.getComponentName()));
