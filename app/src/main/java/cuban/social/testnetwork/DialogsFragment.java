...
import cuban.social.testnetwork.adapter.DialogListAdapter;
import cuban.social.testnetwork.app.App;
import cuban.social.testnetwork.constants.Constants;
import cuban.social.testnetwork.model.Chat;
...
public class DialogsFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                intent.putExtra("unreadMessages", chat.getNewMessagesCount());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        }else if(requestCode == VIEW_CHAT && resultCode == 0){
            onRefresh();
        }
    }
